...
THIS README DEMONSTRATES THE EXECUTION OF THIS
PROGRAM ON A LINUX TERMINAL WITH A C++ COMPILER

-------------------FILE IO--------------------

Please place all plaintext and ciphertext 
files to be processed in the "data" folder.

Make sure to include the extention of the 
file if required.

The output file will also be stored in the
"data" folder.
...
to compile the program along with all 
dependencies:
...
Enter the following command into the terminal 
to remove all objects and .out files 
